...
Καλωσήρθατε στο #zougla. Για να συνδεθείτε στο chat, μπείτε στη σελίδα https://chat.zougla.gr/webchat και στη συνέχεια πατήστε: **Start**
...
Πλέον, κάθε φορά που συνδέεστε από τη σελίδα https://chat.zougla.gr/webchat θα πρέπει να βάζετε το Nickname σας και στο πεδίο I have a password τον κωδικό πρόσβασης που ορίσατε.
